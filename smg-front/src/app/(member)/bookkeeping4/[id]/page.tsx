	...
	React.useEffect(() => {
		const fetchEventAndAttendance = async () => {
			...
			if (eventError) {
				...
				console.log('取得した4期簿記講座情報:', eventData);
				setEvent(eventData);
			}
			...
			if (user) {
				...
				console.log('4期簿記講座参加情報:', { eventAttendanceData, eventAttendanceError });
...
export default Bookkeeping4Detail;
