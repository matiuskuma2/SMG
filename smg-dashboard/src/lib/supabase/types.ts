...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      generate_year_options: { Args: never; Returns: Json };
      get_archive_assets: { Args: { p_archive_id: string }; Returns: Json };
      get_archive_assets_compat: {
        Args: { p_archive_id: string };
        Returns: Json;
      };
      get_consultation_detail_v2: {
        Args: { p_consultation_id: string };
        Returns: Json;
      };
      get_consultation_form_data: {
        Args: { p_consultation_id: string };
        Returns: Json;
      };
      ...
      get_consultations_for_list:
        | {
            Args: { p_instructor_id?: string; p_user_id: string };
            Returns: {
              application_end_at: string;
              application_start_at: string;
              apply_status_code: number;
      ...
      get_current_user_icon: {
        Args: never;
        Returns: {
          icon: string;
        }[];
      };
      get_event_archive_assets: {
        Args: { p_archive_id: string; p_event_id: string };
        Returns: Json;
      };
      get_event_archives: {
        Args: {
      ...
      mark_event_attendee_deleted_debug: {
        Args: { p_event_id: string; p_user_id: string };
        Returns: Json;
      };
      nfc_exchange_upsert_msg: {
      ...
      profile_edit_error_check: {
        Args: { p_nickname?: string; p_phone_num?: string; p_user_id?: string };
        Returns: Json;
      };
      rpc_get_beginner_guide_items_with_counts: {
        Args: { p_user_id: string };
        Returns: Json;
      };
      ...
      rpc_get_question_and_answer_flat: {
        Args: { p_question_id: string };
        Returns: Json;
      };
      rpc_get_question_and_answer_simple: {
        Args: { p_question_id: string };
        Returns: Json;
      };
      rpc_get_question_myself: {
        Args: {
          p_key_word?: string;
          p_limit?: number;
          p_offset?: number;
      ...
      rpc_get_visible_archives_sawabe: {
        Args: {
          p_order_by?: string;
          p_page_offset?: number;
          p_page_size?: number;
          p_theme_filter?: string;
          p_user_id: string;
          p_year_filter?: string;
        };
        Returns: Json;
      ...
      upsert_event_survey_answers_v2: {
...
// Functions
export type ArgsAppGetEventDetail =
  Database['public']['Functions']['app_get_event_detail']['Args'];
export type ReturnTypeAppGetEventDetail =
  Database['public']['Functions']['app_get_event_detail']['Returns'];

export type ArgsApplyEventRegistration =
  Database['public']['Functions']['apply_event_registration']['Args'];
export type ReturnTypeApplyEventRegistration =
  Database['public']['Functions']['apply_event_registration']['Returns'];

export type ArgsCheckConsultationRequiredAnswers =
  Database['public']['Functions']['check_consultation_required_answers']['Args'];
export type ReturnTypeCheckConsultationRequiredAnswers =
  Database['public']['Functions']['check_consultation_required_answers']['Returns'];

export type ArgsCountActiveNotices =
  Database['public']['Functions']['count_active_notices']['Args'];
export type ReturnTypeCountActiveNotices =
  Database['public']['Functions']['count_active_notices']['Returns'];

export type ArgsCreateApplicationWithCandidates =
  Database['public']['Functions']['create_application_with_candidates']['Args'];
export type ReturnTypeCreateApplicationWithCandidates =
  Database['public']['Functions']['create_application_with_candidates']['Returns'];

export type ArgsCreateConsultationApplication =
  Database['public']['Functions']['create_consultation_application']['Args'];
export type ReturnTypeCreateConsultationApplication =
  Database['public']['Functions']['create_consultation_application']['Returns'];

export type ArgsCreateConsultationWithCandidates =
  Database['public']['Functions']['create_consultation_with_candidates']['Args'];
export type ReturnTypeCreateConsultationWithCandidates =
  Database['public']['Functions']['create_consultation_with_candidates']['Returns'];

export type ArgsEventAttendeeCanse =
  Database['public']['Functions']['event_attendee_canse']['Args'];
export type ReturnTypeEventAttendeeCanse =
  Database['public']['Functions']['event_attendee_canse']['Returns'];
...
export type ArgsFnConsultationApply =
  Database['public']['Functions']['fn_consultation_apply']['Args'];
export type ReturnTypeFnConsultationApply =
  Database['public']['Functions']['fn_consultation_apply']['Returns'];

export type ArgsGenerateYearOptions =
  Database['public']['Functions']['generate_year_options']['Args'];
export type ReturnTypeGenerateYearOptions =
  Database['public']['Functions']['generate_year_options']['Returns'];

export type ArgsGetArchiveAssets =
  Database['public']['Functions']['get_archive_assets']['Args'];
export type ReturnTypeGetArchiveAssets =
  Database['public']['Functions']['get_archive_assets']['Returns'];

export type ArgsGetArchiveAssetsCompat =
  Database['public']['Functions']['get_archive_assets_compat']['Args'];
export type ReturnTypeGetArchiveAssetsCompat =
  Database['public']['Functions']['get_archive_assets_compat']['Returns'];

export type ArgsGetConsultationDetailV2 =
  Database['public']['Functions']['get_consultation_detail_v2']['Args'];
export type ReturnTypeGetConsultationDetailV2 =
  Database['public']['Functions']['get_consultation_detail_v2']['Returns'];

export type ArgsGetConsultationFormData =
  Database['public']['Functions']['get_consultation_form_data']['Args'];
export type ReturnTypeGetConsultationFormData =
  Database['public']['Functions']['get_consultation_form_data']['Returns'];

export type ArgsGetConsultationList =
  Database['public']['Functions']['get_consultation_list']['Args'];
export type ReturnTypeGetConsultationList =
  Database['public']['Functions']['get_consultation_list']['Returns'];

export type ArgsGetConsultationPayload =
  Database['public']['Functions']['get_consultation_payload']['Args'];
export type ReturnTypeGetConsultationPayload =
  Database['public']['Functions']['get_consultation_payload']['Returns'];

export type ArgsGetConsultationsForList =
  Database['public']['Functions']['get_consultations_for_list']['Args'];
export type ReturnTypeGetConsultationsForList =
  Database['public']['Functions']['get_consultations_for_list']['Returns'];

export type ArgsGetCurrentUserIcon =
  Database['public']['Functions']['get_current_user_icon']['Args'];
export type ReturnTypeGetCurrentUserIcon =
  Database['public']['Functions']['get_current_user_icon']['Returns'];

export type ArgsGetEventArchiveAssets =
  Database['public']['Functions']['get_event_archive_assets']['Args'];
export type ReturnTypeGetEventArchiveAssets =
  Database['public']['Functions']['get_event_archive_assets']['Returns'];

export type ArgsGetEventArchives =
  Database['public']['Functions']['get_event_archives']['Args'];
export type ReturnTypeGetEventArchives =
  Database['public']['Functions']['get_event_archives']['Returns'];
...
export type ArgsGetLecturerOptions =
  Database['public']['Functions']['get_lecturer_options']['Args'];
export type ReturnTypeGetLecturerOptions =
  Database['public']['Functions']['get_lecturer_options']['Returns'];
...
export type ArgsGetNotificationSettings =
  Database['public']['Functions']['get_notification_settings']['Args'];
export type ReturnTypeGetNotificationSettings =
  Database['public']['Functions']['get_notification_settings']['Returns'];

export type ArgsGetRpcRadio =
  Database['public']['Functions']['get_rpc_radio']['Args'];
export type ReturnTypeGetRpcRadio =
  Database['public']['Functions']['get_rpc_radio']['Returns'];

export type ArgsGetSearchAllItem =
  Database['public']['Functions']['get_search_all_item']['Args'];
export type ReturnTypeGetSearchAllItem =
  Database['public']['Functions']['get_search_all_item']['Returns'];
...
export type ArgsMarkEventAttendeeDeletedDebug =
  Database['public']['Functions']['mark_event_attendee_deleted_debug']['Args'];
export type ReturnTypeMarkEventAttendeeDeletedDebug =
  Database['public']['Functions']['mark_event_attendee_deleted_debug']['Returns'];

export type ArgsNfcExchangeUpsertMsg =
  Database['public']['Functions']['nfc_exchange_upsert_msg']['Args'];
export type ReturnTypeNfcExchangeUpsertMsg =
  Database['public']['Functions']['nfc_exchange_upsert_msg']['Returns'];
...
export type ArgsProfileEditErrorCheck =
  Database['public']['Functions']['profile_edit_error_check']['Args'];
export type ReturnTypeProfileEditErrorCheck =
  Database['public']['Functions']['profile_edit_error_check']['Returns'];

export type ArgsRpcGetBeginnerGuideItemsWithCounts =
  Database['public']['Functions']['rpc_get_beginner_guide_items_with_counts']['Args'];
export type ReturnTypeRpcGetBeginnerGuideItemsWithCounts =
  Database['public']['Functions']['rpc_get_beginner_guide_items_with_counts']['Returns'];
...
export type ArgsRpcGetGatherAttendee =
  Database['public']['Functions']['rpc_get_gather_attendee']['Args'];
export type ReturnTypeRpcGetGatherAttendee =
  Database['public']['Functions']['rpc_get_gather_attendee']['Returns'];

export type ArgsRpcGetMstTheme =
  Database['public']['Functions']['rpc_get_mst_theme']['Args'];
export type ReturnTypeRpcGetMstTheme =
  Database['public']['Functions']['rpc_get_mst_theme']['Returns'];

export type ArgsRpcGetNfcExchange =
  Database['public']['Functions']['rpc_get_nfc_exchange']['Args'];
export type ReturnTypeRpcGetNfcExchange =
  Database['public']['Functions']['rpc_get_nfc_exchange']['Returns'];

export type ArgsRpcGetQuestionAndAnswerFlat =
  Database['public']['Functions']['rpc_get_question_and_answer_flat']['Args'];
export type ReturnTypeRpcGetQuestionAndAnswerFlat =
  Database['public']['Functions']['rpc_get_question_and_answer_flat']['Returns'];

export type ArgsRpcGetQuestionAndAnswerSimple =
  Database['public']['Functions']['rpc_get_question_and_answer_simple']['Args'];
export type ReturnTypeRpcGetQuestionAndAnswerSimple =
  Database['public']['Functions']['rpc_get_question_and_answer_simple']['Returns'];

export type ArgsRpcGetQuestionMyself =
  Database['public']['Functions']['rpc_get_question_myself']['Args'];
export type ReturnTypeRpcGetQuestionMyself =
  Database['public']['Functions']['rpc_get_question_myself']['Returns'];
...
export type ArgsRpcGetVisibleArchivesSawabe =
  Database['public']['Functions']['rpc_get_visible_archives_sawabe']['Args'];
export type ReturnTypeRpcGetVisibleArchivesSawabe =
  Database['public']['Functions']['rpc_get_visible_archives_sawabe']['Returns'];
...
export type ArgsRpcSearchAllItems =
  Database['public']['Functions']['rpc_search_all_items']['Args'];
export type ReturnTypeRpcSearchAllItems =
  Database['public']['Functions']['rpc_search_all_items']['Returns'];
...
export type ArgsSearchEventsV2 =
  Database['public']['Functions']['search_events_v2']['Args'];
export type ReturnTypeSearchEventsV2 =
  Database['public']['Functions']['search_events_v2']['Returns'];
...
export type ArgsToggleNotificationSetting =
  Database['public']['Functions']['toggle_notification_setting']['Args'];
export type ReturnTypeToggleNotificationSetting =
  Database['public']['Functions']['toggle_notification_setting']['Returns'];
...
export type ArgsUpsertEventSurveyAnswersV2 =
  Database['public']['Functions']['upsert_event_survey_answers_v2']['Args'];
export type ReturnTypeUpsertEventSurveyAnswersV2 =
  Database['public']['Functions']['upsert_event_survey_answers_v2']['Returns'];
