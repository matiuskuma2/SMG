...
interface IndividualConsultationListSearchProps {
  searchQuery: string;
...
export const IndividualConsultationListSearch: React.FC<
  IndividualConsultationListSearchProps
> = ({
  searchQuery,
  handleSearch,
  sortBy,
      ...
      >
        ...
        >
          ...
          >
            ...
            <option value="applicationDate">申込期限でソート</option>
